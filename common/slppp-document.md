# SLP++ Document Protocol Specification
...
## Document ID
```
The document is identified by sha256 the create document transaction output (txid + n) which can be regarded as `document_id`.
```

## Transaction Detail

### Create - Create Document Transaction

This transaction defines the properties, metadata and document itself. 
...
### UPDATE - Update Document Transaction
